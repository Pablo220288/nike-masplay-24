  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-start w-full h-screen absolute z-50 overflow-hidden">
        <div className="w-full max-w-[450px] h-full flex flex-col pt-[100px] px-4 pb-4 items-start justify-start">
          <div className="w-full flex flex-col items-start">
            ...
            <details
              ...
              className="w-full rounded-md border-2 border-blue-gray-200"
            >
              <summary className="w-full cursor-pointer p-2 text-black flex items-center">
              ...
              <div className="flex items-start gap-2 pl-4 py-2">
                <span className="text-sm font-light text-black text-center uppercase text-black">
                  NIKE LATAM:
                </span>
